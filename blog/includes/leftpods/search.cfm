...
<!--- <cfmodule template="../../tags/podlayout.cfm" title="#application.resourceBundle.getResource("search")#"> --->
    ...
    <div class="search">
		<form action="#application.rooturl#/search.cfm" method="post" onsubmit="return(this.search.value.length != 0)">
			...
			<input name="search" id="search" class="keyword" type="text" /> 
			<div class="btn">
			 <input type="image" alt="Get Results" class="search-button" src="#application.rooturl#/images/matt/search.gif" value="#application.resourceBundle.getResource("search")#" />
			</div>  
		</form>				
  	</div>
	</cfoutput>
