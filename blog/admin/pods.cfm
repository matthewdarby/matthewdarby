...
<cfparam name="url.dir" default="leftpods" /> 
<cfset dir = expandPath("../includes/#url.dir#")>
...
<cfmodule template="../tags/adminlayout.cfm" title="Pods">
	...
	<form action="pod.cfm?dir=#url.dir#" method="post" name="PodUpdate">
	...
	<cfoutput query="pods">
		<tr class="adminList<cfif currentRow mod 2>1</cfif>">
			...
			<td>#name#</td>
			<td>
				[<a href="showpods.cfm?pod=#name#&dir=#url.dir#" target="PodWin" onclick="window.open(this.href,this.target,'width=215,height=400');return false;">Show sample output</a> ]
				[<a href="podform.cfm?pod=#name#&dir=#url.dir#">Edit Pod</a>]
				[<a href="pods.cfm?deletePod=#name#&dir=#url.dir#">Delete Pod</a>]
 			</td>
	...
	<cfoutput></table>
		<div align="right" style="margin-right:15px;">
			[<a href="podform.cfm?dir=#url.dir#">Add New Pod</a> ] 
