...
<cfcomponent hint="I am the database agnostic custom Record object for the dv_device object.  I am generated, but not overwritten if I exist.  You are safe to edit me."
	extends="reactor.project.Matt.Record.dv_deviceRecord" >
