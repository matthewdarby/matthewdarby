...
<cfcomponent hint="I am the database agnostic custom Gateway object for the reference object.  I am generated, but not overwritten if I exist.  You are safe to edit me."
	extends="reactor.project.Matt.Gateway.referenceGateway" >
